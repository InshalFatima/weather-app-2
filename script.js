...
function getWeather() {
    ...
    $.ajax({
        url:`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&APPID=d349cf8b1f5a951fbfa05136d66a7843&units=metric`,
    ...
    $.ajax({
         url:`https://api.openweathermap.org/data/2.5/forecast?q=karachi,pk&appid=d349cf8b1f5a951fbfa05136d66a7843&units=metric`,
         success: function (data) {
            console.log(data);
